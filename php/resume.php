...
$edu_graduation=$_REQUEST['edu_graduation_date'];
...
$sql="INSERT INTO `resume details`( `firstname`, `middlename`, `lastname`, `designation`, `adress`, `email`, `phoneno`, `summary`, `achive_title`, `achive_description`, `exp_title`, `exp_organization`, `exp_location`, `exp_start_date`, `exp_end_date`, `exp_description`, `edu_school`, `edu_degree`, `edu_city`, `edu_start_date`, `edu_end_date`, `edu_description`, `proj_title`, `proj_link`, `proj_description`, `skills`)
 VALUES ('$firstname','$middlename','$lastname','$designation','$adress','$Email','$phno','$summary',
 '$acti','$acdesc','$exp_title','$exp_organization','$exp_location','$exp_start_date','$exp_end_date',
 '$exp_description','$edu_school','$edu_degree','$edu_city','$edu_start','$edu_graduation',
...
if($results){
    ...
    <hr>
    <p class="mb-0">your data has been stored succesfully!</p>
  </div>';

}else{
    echo '<script>
    alert ("FAILED DATA BASE ERROR");
    </script>';
}
?>
<!-- datastore end -->
